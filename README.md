...
- **<b>[Reporting Mania](https://github.com/root-kush369/ReportingMania)</b>** Reportify is a dynamic reporting tool built with React, Vite, and Tailwind CSS on the frontend, and Node.js, Express, and Supabase on the backend, enabling users to generate, filter, export (PDF), and schedule (email) reports for finance, HR, and CRM systems.
